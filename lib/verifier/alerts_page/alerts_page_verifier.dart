...
class AlertsPageVerifier extends StatefulWidget {
  const AlertsPageVerifier({super.key});

  @override
  State<AlertsPageVerifier> createState() => _AlertsPageVerifierState();
}

class _AlertsPageVerifierState extends State<AlertsPageVerifier> {
  @override
