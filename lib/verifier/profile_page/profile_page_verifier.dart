...
class ProfilePageVerifier extends StatefulWidget {
  const ProfilePageVerifier({super.key});

  @override
  State<ProfilePageVerifier> createState() => _ProfilePageVerifierState();
}

class _ProfilePageVerifierState extends State<ProfilePageVerifier> {
  String orgName = "";
  String userName = "";
  String userEmail = "";
  String orgLocation = "";
